...
public record OrderResponseDto(Long id, CustomerResponseDto customer, String createdAt, List<OrderItemResponseDto> orderItems, BigDecimal totalValue, AddressResponseDto addressDelivery, String status) {
}
